...
# from industry.stock_select import stock_select_
# from industry.industry_leader_maker import industry_leader_maker_
# from industry.leader_compare import leader_moderate
# from industry.leader_factor import leader_factor_maker
from industry.leader_multifactor import *
# from industry.GD_location_maker import *
...
factor_list = ['pe_ttm', 'total_mv', 'QFA_ROE_DEDUCTED']
factor_type = ['base', 'base', 'financial']
...
performance_(hs300, banchmark, returns, extra, str(factor_list), ': leader_factor')
